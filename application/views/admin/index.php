...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	...
	<a href="<?php echo site_url('admin/reports'); ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
				...
				<div class="row no-gutters align-items-center">
					<div class="col mr-2">
						<div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
							Cuotas pendientes del mes</div>
						<div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $qtyMonthQuotas->qty ?></div>
					</div>
					<div class="col-auto">
